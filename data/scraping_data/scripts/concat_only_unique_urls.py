...
input_old = '../csv/yahoo_news/concat/yahoo_news_concat_1126_v2.csv'
input_new = '../csv/yahoo_news/daily/yahoo_news_articles_1126_v3.csv'

output_path = '../csv/yahoo_news/concat/yahoo_news_concat_1126_v3.csv'
